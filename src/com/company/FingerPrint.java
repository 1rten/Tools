...
public final class FingerPrint {
    ...
    public static void main(String[] args) throws IOException {
        String file1 = "./DataResource/1134_00.png";
        String file2 = "./DataResource/1134_04.png";
        FingerPrint fp1 = new FingerPrint(ImageIO.read(new File(file1)));
        FingerPrint fp2 = new FingerPrint(ImageIO.read(new File(file2)));
        ...
        System.out.println("sim = " + fp1.compare(fp2));
        System.out.println("sim = " + compare(image1, image2));
        System.out.println(FileDigest.getFileMD5(new File(file1)));
        System.out.println(FileDigest.getFileMD5(new File(file2)));
        String file3 = "./DataResource/test.png";
        new ImageCompare().compare(file1, file2, file3);
    }
